...
export class PointCollection {
    ...
    constructor(str : string, range: any, private config : any) {
        this.points = parsePoints(str, range);
    }
...
function parsePoints(str : string, range: any) : Point[] {
    let letterColors = [red, orange, green, blue, purple];
    ...
    let xmid = (xmin+xmax)/2; let xcenter = (range.right+range.left)/2;
    let ymid = (ymin+ymax)/2; let ycenter = (range.top+range.buttom)/2;
